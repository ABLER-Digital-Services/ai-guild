...
本リポジトリでは、運用チームメンバを募集しています。

- Pull Request のレビューに協力できる人
- 資産の運用ルールや品質ゲートの改善に関心がある人

参加や役割について相談したい場合は、[SUPPORT.md](SUPPORT.md) を参照してください。

## アクセス制限と公開範囲

本リポジトリは、社内からのアクセスについて IP アドレス制限を前提に運用しています。

一方で、リポジトリ自体は Public で公開しているため、GitHub アカウントを持っていなくても社内ネットワークからであれば誰でも閲覧は可能です。
